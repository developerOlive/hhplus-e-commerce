...
public class BalanceController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공", content = @Content(examples = @ExampleObject(value = BalanceSwaggerDocs.BALANCE_SUCCESS))),
            @ApiResponse(responseCode = "404", description = "사용자 없음", content = @Content(examples = @ExampleObject(value = BalanceSwaggerDocs.BALANCE_NOT_FOUND)))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "충전 성공", content = @Content(examples = @ExampleObject(value = BalanceSwaggerDocs.BALANCE_CHARGE_SUCCESS))),
            @ApiResponse(responseCode = "400", description = "요청 오류 (금액 누락, 음수 등)", content = @Content(examples = {
                    @ExampleObject(name = "금액 누락", value = BalanceSwaggerDocs.BALANCE_CHARGE_AMOUNT_REQUIRED),
                    @ExampleObject(name = "0 이하 금액", value = BalanceSwaggerDocs.BALANCE_CHARGE_AMOUNT_POSITIVE)
            })),
            @ApiResponse(responseCode = "404", description = "사용자 없음", content = @Content(examples = @ExampleObject(value = BalanceSwaggerDocs.BALANCE_CHARGE_USER_NOT_FOUND)))
    })
