package com.hhplusecommerce.interfaces.payment.controller;

import com.hhplusecommerce.interfaces.payment.dto.PaymentRequest;
import com.hhplusecommerce.interfaces.payment.dto.PaymentResponse;
import com.hhplusecommerce.support.response.ApiResult;
import com.hhplusecommerce.interfaces.payment.docs.PaymentSwaggerDocs;
...
public class PaymentController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "결제 실패", content = @Content(examples = @ExampleObject(value = PaymentSwaggerDocs.PAYMENT_FAILED)))
    })
